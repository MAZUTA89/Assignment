...
namespace BTS_Assignment.Printing
{
    public class AssignPrinting
    {
        ...
        void InitializeTags()
        {
            ...
            {
                tags[PrintConfig.Доверенность] = _currentEmployeeSettings.TrustNumber;
            }

            if (tags.ContainsKey(PrintConfig.Должность))
            {
                tags[PrintConfig.Должность] = _currentEmployeeSettings.LastPost;
            }
            ...
            {
                tags[PrintConfig.Получатель] = _mainWindow.LoadHolderTextBox.Text;
            }
            ...
            {
                tags[PrintConfig.ФИО] = _currentEmployeeSettings.LastFullName;
            }
